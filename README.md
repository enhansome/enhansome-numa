...
* [RAM Coffers](https://github.com/Scottcjn/ram-coffers) ⭐ 165 | 🐛 25 | 🌐 Python | 📅 2026-09-03 - NUMA-aware weight banking for LLM inference on IBM POWER8, routing model weights to cognitive-function-mapped NUMA nodes with prefetch hints
...
* [pcm-numa](https://github.com/opcm/pcm) ⭐ 3,327 | 🐛 69 | 🌐 C++ | 📅 2026-09-08- A tool to monitor local and remote memory accesses on a NUMA system
