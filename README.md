...
* [hwloc](https://github.com/open-mpi/hwloc) ⭐ 738 | 🐛 151 | 🌐 C | 📅 2026-09-20 - A portable API to detect and exploit the topology of parallel architectures
...
* [RAM Coffers](https://github.com/Scottcjn/ram-coffers) ⭐ 170 | 🐛 26 | 🌐 Python | 📅 2026-09-03 - NUMA-aware weight banking for LLM inference on IBM POWER8, routing model weights to cognitive-function-mapped NUMA nodes with prefetch hints
