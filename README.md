...
* [hwloc](https://github.com/open-mpi/hwloc) ⭐ 735 | 🐛 149 | 🌐 C | 📅 2026-09-03 - A portable API to detect and exploit the topology of parallel architectures
...
* [Umpire](https://github.com/LLNL/Umpire) ⭐ 421 | 🐛 35 | 🌐 C++ | 📅 2026-09-03 - An application-focused API for memory management on NUMA & GPU architectures

* [RAM Coffers](https://github.com/Scottcjn/ram-coffers) ⭐ 163 | 🐛 19 | 🌐 Python | 📅 2026-09-03 - NUMA-aware weight banking for LLM inference on IBM POWER8, routing model weights to cognitive-function-mapped NUMA nodes with prefetch hints
...
* [pcm-numa](https://github.com/opcm/pcm) ⭐ 3,321 | 🐛 69 | 🌐 C++ | 📅 2026-08-11- A tool to monitor local and remote memory accesses on a NUMA system
...
* [NumaMMA](https://github.com/numamma/numamma) ⭐ 31 | 🐛 4 | 🌐 C | 📅 2025-06-10 - A lightweight NUMA memory profiler/analyzer and a NUMA application execution engin
