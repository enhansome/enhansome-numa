...
* [hwloc](https://github.com/open-mpi/hwloc) ⭐ 732 | 🐛 149 | 🌐 C | 📅 2026-08-20 - A portable API to detect and exploit the topology of parallel architectures
...
* [Umpire](https://github.com/LLNL/Umpire) ⭐ 419 | 🐛 35 | 🌐 C++ | 📅 2026-08-13 - An application-focused API for memory management on NUMA & GPU architectures

* [RAM Coffers](https://github.com/Scottcjn/ram-coffers) ⭐ 159 | 🐛 9 | 🌐 Python | 📅 2026-08-20 - NUMA-aware weight banking for LLM inference on IBM POWER8, routing model weights to cognitive-function-mapped NUMA nodes with prefetch hints
