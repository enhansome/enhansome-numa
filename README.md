...
* [hwloc](https://github.com/open-mpi/hwloc) ⭐ 735 | 🐛 150 | 🌐 C | 📅 2026-09-02 - A portable API to detect and exploit the topology of parallel architectures
...
* [RAM Coffers](https://github.com/Scottcjn/ram-coffers) ⭐ 160 | 🐛 19 | 🌐 Python | 📅 2026-08-29 - NUMA-aware weight banking for LLM inference on IBM POWER8, routing model weights to cognitive-function-mapped NUMA nodes with prefetch hints
...
* [pcm-numa](https://github.com/opcm/pcm) ⭐ 3,322 | 🐛 69 | 🌐 C++ | 📅 2026-08-11- A tool to monitor local and remote memory accesses on a NUMA system
