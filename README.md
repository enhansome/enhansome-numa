...
* [hwloc](https://github.com/open-mpi/hwloc) ⭐ 732 | 🐛 148 | 🌐 C | 📅 2026-08-20 - A portable API to detect and exploit the topology of parallel architectures
...
* [RAM Coffers](https://github.com/Scottcjn/ram-coffers) ⭐ 159 | 🐛 17 | 🌐 Python | 📅 2026-08-29 - NUMA-aware weight banking for LLM inference on IBM POWER8, routing model weights to cognitive-function-mapped NUMA nodes with prefetch hints
